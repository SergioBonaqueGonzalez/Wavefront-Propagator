function [x2,Uout]=Fresnel_2step_Propagation(config,object,image)
%{
...
This method evaluates the Fresnel integral twice, which
adds some flexibility in the grid spacing at the cost of performing a
second FT. It is usefull in applications where the fixed value of grid spacing in  does not sample
